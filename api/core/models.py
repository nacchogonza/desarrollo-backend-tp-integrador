...
class Producto(Base):
    ...
    remito_compra = relationship("RemitoCompra", back_populates="producto", uselist=False)
    remito_venta = relationship("RemitoVenta", back_populates="producto", uselist=False)
    remito_devolucion = relationship("RemitoDevolucion", back_populates="producto", uselist=False)
    remito_transferencia = relationship("RemitoTransferencia", back_populates="producto", uselist=False)
...
class Proveedor(Base):
    ...
    remito_compra = relationship("RemitoCompra", back_populates="proveedor", uselist=False)
